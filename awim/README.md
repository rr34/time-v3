...
- clockactions.get_astrodata(location, momentsarray, requestlist, MagRankAllMax, LatDec_filter)
...
- clockactions.get_celestialinphoto(awim_dict, momentsarray, bodies_astro_dict, inimage_threshold=2, padding_percent = 5)
