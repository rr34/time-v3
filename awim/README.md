...
- Use the calspreadsheet Excel file in `docs-example-files`, and fill in the yellow boxes based on the reference grid. It must be named `calspreadsheet.xlsx`
...
## @app.post('/getevents')
- tv3clock.clockactions.get_events(location, elevation_msl, currenttime)
...
## Clock API Docs
- See `docs/tv3clock.md` for end-to-end clock flow maps.

## @app.post('/celestialinphotos')
- tv3clock.clockactions.get_astrodata(location, momentsarray, requestlist, MagRankAllMax, LatDec_filter)
...
- tv3clock.clockactions.get_celestialinphoto(awim_dict, momentsarray, bodies_astro_dict, inimage_threshold=2, padding_percent = 5)
...
![Alt text](docs-readme-images/tutorial-01.jpg)

Navigate to the `test/` directory included and select the `.csv` file:

![Alt text](docs-readme-images/tutorial-02.jpg)
...
![Alt text](docs-readme-images/cal-sony.jpg)
...
![Alt text](docs-readme-images/tutorial-03.jpg)

You should see two plots:

![Alt text](docs-readme-images/tutorial-04.jpg)
...
![Alt text](docs-readme-images/tutorial-05.jpg)

Select `Load image` and select one of the PNG files in the `test files/` directory.

![Alt text](docs-readme-images/tutorial-06.jpg)
...
![Alt text](docs-readme-images/tutorial-09.jpg)
