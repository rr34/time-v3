...
def get_exif_location_moment(current_image, tz_default):


    if locationAltitude:
        img_locationAltitude_AWIMtag = 'LocationAltitude: %f meters above sea level' % locationAltitude
        img_locationAltitudeSource_AWIMtag = 'DSC exif GPS'
    else:
        img_locationAltitude_AWIMtag = False
        img_locationAltitudeSource_AWIMtag = False

    if UTC_datetime_str:
        img_datetime_AWIMtag = '' + UTC_datetime_str



    return UTC_datetime_str, UTC_source, location, locationAltitude    
    rotate_degrees = 0
    img_latlng = None
    img_elevation = None
